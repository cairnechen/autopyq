...
Use this skill when the user wants to publish text, images, or a mixed post to WeChat Moments/朋友圈 with the local packaged runner, or when the user needs to refresh the pyq1-pyq4 reference images used by the ImageSearch workflow.
